# ERP_Reports/management/commands/apprunner.py
"""
Ad-hoc runner: generate the COGS report (Excel) and email it.
Use when you want to trigger a one-off send from the command line.

Examples:
  python manage.py apprunner --to finance@ocspl.com
  python manage.py apprunner --to a@b.com,c@d.com --range mtd --subject "COGS (MTD)"
  python manage.py apprunner --to you@ocspl.com --from-date 2025-08-01 --to-date 2025-08-26 \
...
class Command(BaseCommand):
    help = "Generate COGS report (Excel) and email it (one-off)."
...
"""
    ...
    def _conn_alias() -> str:
        ...
        try:
            return "readonly_db" if "readonly_db" in settings.DATABASES else "default"
        except Exception:
            return "default"
